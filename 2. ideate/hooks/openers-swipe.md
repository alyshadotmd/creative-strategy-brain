...
*Library file, not a skill. The structural DNA `hook-writing` draws on so hooks read as native to the feed rather than constructed.*

Templates only — the brand, persona and pain get plugged in. A template used without a persona and a trigger moment behind it produces a line that sounds right and means nothing. Add to this file whenever a structure proves itself in the wild.
